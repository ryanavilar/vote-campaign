...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn33-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn33-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn33-web-dpt.txt", "utf8");
