...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn27-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn27-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn27-web-dpt.txt", "utf8");
