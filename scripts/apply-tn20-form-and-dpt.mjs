...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn20-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn20-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn20-web-dpt.txt", "utf8");
