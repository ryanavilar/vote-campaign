...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn29-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn29-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn29-web-dpt.txt", "utf8");
