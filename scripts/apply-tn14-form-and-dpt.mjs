...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn14-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn14-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn14-web-dpt.txt", "utf8");
