...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn23-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn23-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn23-web-dpt.txt", "utf8");
