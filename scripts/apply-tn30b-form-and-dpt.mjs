...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn30-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn30-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn30-web-dpt.txt", "utf8");
