...
// ---------- 1. Form xlsx ----------
console.log("=== STEP 1: Form DPT (tn31-formdpt.xlsx, valid-only) ===");
const wb = XLSX.read(readFileSync("tn31-formdpt.xlsx"), { type: "buffer" });
...
const pdfText = readFileSync("scripts/_tn31-web-dpt.txt", "utf8");
